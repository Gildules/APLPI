set -gx CONDA_EXE (cygpath "C:/Dev/Jupyter/dist/ms_reader\Scripts\conda.exe")
set _CONDA_ROOT (cygpath "C:/Dev/Jupyter/dist/ms_reader")
set _CONDA_EXE (cygpath "C:/Dev/Jupyter/dist/ms_reader\Scripts\conda.exe")
set -gx CONDA_PYTHON_EXE (cygpath "C:/Dev/Jupyter/dist/ms_reader\python.exe")
